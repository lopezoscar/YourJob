...
<iframe id ="iFrame"src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Flocalhost%3A8080%2FYourJob&amp;send=false&amp;layout=button_count&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;"
 ...
 allowTransparency="true"></iframe>
  -->
			...
			<div id="nav">
				<a href="../header/login.jsp">Login</a> <a
					href="../header/empresa.jsp">Empresa</a> <a
					href="../header/cv.jsp">Subi tu CV</a>
			</div>
...
-->
		...
		<div id="auspiciantes">
				<a href="jsp/busquedasAuspiciantes.jsp" title="Google logo"><img src="../../imagenes/auspiciantes/google125.jpg" />
				</a>
				<a href="jsp/busquedasAuspiciantes.jsp" title="Cisco logo"><img src="../../imagenes/auspiciantes/CISCO.jpg" />
				</a> 
				<a href="jsp/busquedasAuspiciantes.jsp" title="Oracle logo"><img src="../../imagenes/auspiciantes/oracle150.jpg" />
				</a> 
				<a href="jsp/busquedasAuspiciantes.jsp" title="IBM logo"><img src="../../imagenes/auspiciantes/ibm-gif.gif" />
				</a>
				<a href="jsp/busquedasAuspiciantes.jsp" title="Deloitte Logo"><img src="../../imagenes/auspiciantes/deloitteLogo.jpg" />
				</a>
			</div>
			<!-- Fin Auspiciantes -->
		...
		<form>
			...
			<!-- Fin requerimientos style="float:right;-->
			
			<div id="descripcion" class="descripcion" ">
			<h4>Descripción</h4>
					<p>Es un proyecto para sumarseal área de Sistemas, para trabajar en diversos proyectos junto a un equipo de profesionales con alta dosis de creatividad y pasión por los desafíos.
Las tecnologías a utilizar serían: JAVA, J2EE, webservice, Base de Datos (sql, plsql, transactsql), Unix, Solaris y C++(no excluyente).
Principalmente se realizará la programación back-end y mantenimiento de algunos de sus productos Network, tales como Free Phone, Broadcast Messaging, entre otros, 
y en la medida en la que la persona vaya conociendo más las soluciones, realizará el análisis, diseño y arquitectura de las mismas.</p>
				
			</div>
			
			
		<div id="infoEmp">
			<img src="../../imagenes/auspiciantes/google125.jpg" alt="Google Info" title="Google Info"/>
			<h4>Info</h4>
			<p>Google es el buscador mas utilizado del mundo. Su sede en argentina cuenta con 1000 empleados, la misma se encuentra en puerto madero</p>
		</div>
